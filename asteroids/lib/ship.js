(function(){
  ...
  Ship.prototype.fireBullet = function() {
      ...
      var bullet = new Asteroids.Bullet({pos: this.position.slice(0),
                                         vel: this.bulletVelocity.slice(0),
                                         game: this.game
                                       });
      bullet.velocity = Asteroids.Util.asteroidNorm([this.cursorX, this.cursorY], this.position.slice(0));
      bullet.velocity[0] *= 3;
      bullet.velocity[1] *= 3;
